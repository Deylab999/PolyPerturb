...
gg_edgelist = read.table("/n/groups/price/kushal/extras/depmap/gg_edgelist_depmap.txt", header=F)
...
write.table(ccmat, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_Depmap_MAGMA_PoPS.txt"),
...
rownames(ccmat) = common_genes
colnames(ccmat) = common_traits
write.table(ccmat, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_Depmap_MAGMA.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
...
rownames(ccmat) = common_genes
colnames(ccmat) = common_traits
write.table(ccmat, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_Depmap_PoPS.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
