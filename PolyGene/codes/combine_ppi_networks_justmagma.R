tabb1 = read.table("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_CoExpressDB_MAGMA.txt")
tabb2 = read.table("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_Dorothea_MAGMA.txt")
tabb3 = read.table("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_Depmap_MAGMA.txt")
tabb4 = read.table("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_HuMap_MAGMA.txt")
tabb5 = read.table("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/PPI_STRING_MAGMA.txt")
...
write.table(ccmat1, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/Combo_PPI_All_Max_justMAGMA.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
write.table(ccmat2, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/Combo_PPI_All_Mean_justMAGMA.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
write.table(ccmat3, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/Combo_PPI_All_WtdMean_justMAGMA.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
write.table(ccmat4, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/Combo_PPI_CoexpressDB_STRING_Max_justMAGMA.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
write.table(ccmat5, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/Combo_PPI_CoexpressDB_STRING_Mean_justMAGMA.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
write.table(ccmat6, file = paste0("/n/groups/price/kushal/GeneRank/Genes_by_X/Network_plus/Combo_PPI_CoexpressDB_STRING_WtdMean_justMAGMA.txt"),
            row.names = T, col.names = T, sep = "\t", quote=F)
