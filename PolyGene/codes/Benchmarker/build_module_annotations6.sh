genescore_cell=/n/groups/price/kushal/GeneRank/data/Gene_Scores/Benchmarker
bed_cell=/n/groups/price/kushal/singlecellLDSC/data/BEDFILES/Benchmarker
enhancer_tissue=BRN
...
TASKFILE=/n/groups/price/kushal/GeneRank/data/Tnames2.txt
